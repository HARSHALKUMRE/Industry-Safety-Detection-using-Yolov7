...
from industry.entity.config_entity import DataValidationConfig
from industry.entity.artifacts_entity import DataIngestionArtifact, DataValidationArtifact
